...
public final class ListItemBinding implements ViewBinding {
  ...
  private ListItemBinding(@NonNull ConstraintLayout rootView, @NonNull MaterialCheckBox checkBox,
  ...
  public static ListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListItemBinding((ConstraintLayout) rootView, checkBox, titleTextView);
    }
